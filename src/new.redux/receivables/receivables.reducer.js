...
import getReceivablesInitialState from './receivables.initialState';

const reducer = (state = getReceivablesInitialState(), { type, payload }) => {
  switch (type) {
    ...
    case constants.SET_INITIAL_STATE: {
      return getReceivablesInitialState();
    }
