                ...
                <Col md="8" sm="12">
                  <FormGroup>
                    <Label for="permission_id">
                      <FormattedMessage id='permission_user.permission_id' />
                    </Label>
                    <Input
                      type="text"
                      id="permission_id"
                      ...
                      placeholder={intl.formatMessage({id:"permission_user.permission_id"})}
                    />
                    {formik.errors.permission_id && formik.touched.permission_id ? (
                      <div className="invalid-tooltip mt-25">{formik.errors.npermission_idame}</div>
                    ) : null}
                  </FormGroup>
                </Col>
                <Col md="4" sm="12">
                  <FormGroup>
                    <Label for="company_id">
                      <FormattedMessage id='permission_user.company_id' />
                    </Label>
                    <Input
                      type="text"
                      id="company_id"
                      ...
                      onChange={formik.handleChange}
                      placeholder={intl.formatMessage({id:"permission_user.company_id"})}
                    />
                    {formik.errors.company_id && formik.touched.company_id ? (
                      <div className="invalid-tooltip mt-25">{formik.errors.company_id}</div>
                    ) : null}
                  </FormGroup>
                </Col>
              </Row>
                ...
                <Col sm="12">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={formik.handleChange}
                      placeholder={intl.formatMessage({id:"cost_centers.description"})}
                    />
                    {formik.errors.description && formik.touched.description ? (
                      <div className="invalid-tooltip mt-25">{formik.errors.description}</div>
                    ) : null}
                  </FormGroup>
                </Col>
              </Row>
            </Col>
            <Col className="d-flex justify-content-end flex-wrap" md={{size: 6, offset: 3}} sm="12">
              <Button.Ripple
                className="mt-1"
                color="primary"
