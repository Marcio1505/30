...
import { getDre } from '../../../../services/apis/statements.api';
...
const DrePage = ({ currentCompanyId, currentCompany, currentUser }) => {
  const intl = useIntl();
  ...
  const loadDreData = async ({ params = null } = {}) => {
    const newDreData = await getDre({
      params,
    });
  ...
  return (
    <>
      <PermissionGate permissions="api.statements.getDre">
        <Breadcrumbs breadCrumbTitle="Dre" breadCrumbActive="Dre" />
        <Card>
          <CardBody>
              ...
              <Row>
                <Col className="d-flex justify-content-end flex-wrap" sm="12">
                  <Button.Ripple
                    ...
                    type="submit"
                  >
                    <FormattedMessage id="button.load.statement.dre" />
                  </Button.Ripple>
                </Col>
              </Row>
            </Form>
...
export default connect(mapStateToProps)(DrePage);
